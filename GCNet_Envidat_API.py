...
for st,site in enumerate(sites):
    ...
    # if sites2[st]!='null' :
        ...
        if sites2[st]=='NAU':
            ...
            df=adjuster(sites_BAV_convention[st],df,['winddir1','winddir2'],2022,2,1,'nan_var',2022,4,22,'instrument frozen by frost?',0)
        ...
        if sites2[st]=='SUM':
            ...
            df=adjuster(sites_BAV_convention[st],df,['TA1','TA2'],2021,12,1,'max_filter',2022,4,15,'xmit outlier?',0)
        ...
        if sites2[st]=='NAE':
            ...
            df=adjuster(sites_BAV_convention[st],df,['winddir2'],2021,6,1,'nan_var',2022,5,8,'partially broken?',0)
