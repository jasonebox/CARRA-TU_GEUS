...
t0=datetime(2022,7,28) ; t1=datetime(2022, 8, 9,12) ; site='SWC'
t0=datetime(2022,8,1) ; t1=datetime(2022, 8, 9,12) ; site='JAR'
# t0=datetime(2022,8,3) ; t1=datetime(2022, 8, 9,12) ; site='SWC_U'
